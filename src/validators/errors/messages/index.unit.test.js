...
// if invalid, ajvValidate.errors will be populated with an array of errors, which look like:
//  [
//    {
//      "keyword":"type",
//      "dataPath":".bio",
...
describe('generateValidationErrorMessage', function () {
  ...
  it('should return the correct string when the error.keyword is not recognized', function () {
    const errors = [{}];
    const actualErrorMessage = generateValidationErrorMessage(errors);
